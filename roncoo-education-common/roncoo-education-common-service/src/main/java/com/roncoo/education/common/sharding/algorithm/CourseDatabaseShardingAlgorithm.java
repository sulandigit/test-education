 ...
 * @author sharding
 */
public class CourseDatabaseShardingAlgorithm implements StandardShardingAlgorithm<Long> {

    private Properties props;
    private int shardingCount = 2; // 默认分2个库
    ...
    public String doSharding(Collection<String> collection, PreciseShardingValue<Long> preciseShardingValue) {
        ...
        // 计算分库索引
        int dbIndex = (int) (courseId % shardingCount);
        
        // 根据配置的数据源名称前缀构造目标数据源名称
        String targetDataSource = String.format("course-db-%d", dbIndex);
